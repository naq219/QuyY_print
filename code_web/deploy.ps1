...
$ProjectName = "quyy-print"

Write-Host ""
Write-Host "=============================" -ForegroundColor Cyan
Write-Host "  Deploy QuyY Print Web" -ForegroundColor Cyan
Write-Host "=============================" -ForegroundColor Cyan
Write-Host ""
...
if (-not $Prod -and -not $Preview) {
  ...
  Write-Host "  1) Production  ($ProjectName.pages.dev)"
  Write-Host "  2) Preview     (<hash>.$ProjectName.pages.dev)"
  Write-Host ""
